        ...
        public GameMap(int level, Action winCallback, Action loseCallback) {
            switch (level) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    _width = level6.GetLength(0);
                    _height = level6.GetLength(1);
                    InitializeMap(level6);
                    break;
                case 7:
                    _width = level7.GetLength(0);
                    _height = level7.GetLength(1);
                    InitializeMap(level7);
                    break;
            ...
            for (int y = 0; y < _height; y++) {
                for (int x = 0; x < _width; x++) {
                    ...
                    if (Map[x, y].Peek().TileType == TileType.Rule) {
                        ...
                        Console.Write(Map[x, y].Peek().Name.First() == '.' ? ". " : Map[x, y].Peek().Name.First() + " ");
                        //Console.Write("  ");
                    }
                }
                Console.WriteLine();
